...
5. Run `./scripts/export-tokens.sh`, which also regenerates GPUI assets and synchronizes the skill snapshot.
6. Update `CHANGELOG.md`.
7. Run the repository checks and the GPUI gallery compile check.
